...
function HeroSection() {
  return (
    <section className="bg-[url('https://images.unsplash.com/photo-1523050854058-8df90110c9f1')] bg-cover bg-center">
      <div className="flex h-screen items-center justify-center bg-gradient-to-r from-blue-800/90 to-blue-600/90">
        <div className="max-w-4xl px-4 text-center">
          ...
          <Button>Check Your Eligiblity</Button>
          <div className="mt-8 text-sm text-gray-300 md:text-base">
